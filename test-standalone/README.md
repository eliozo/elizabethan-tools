# Valodu tehnoloģijas un mākslīgais intelekts


## Cilvēka vadīta mācību materiālu automatizēta tulkošana

**Elizabete Ozoliņa, 2.kurss**
...
Rīks programmēts valodā Python un tiek integrēts ar Tikal, pandoc un Tildes mašīntulkotāju.

### Sākotnējā konfigurācija

Projektu pārkopē caur `git clone`. Pirms lietošanas jāuzstāda fails `bin/properties.txt`.  
